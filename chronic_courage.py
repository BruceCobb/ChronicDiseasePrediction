...
# 正例的比例!
manbing_Positive = manbing.where(manbing.drug_5 == '1').count()
# 负例的比例!
manbing_Nagtive = manbing.where(manbing.drug_5 == '0').count()
...
manbing = manbing.sampleBy("drug_5", fractions={'0': 20000/manbing_Nagtive, '1': 20000/manbing_Positive}, seed=0)
# 从源数据中指定（糖尿病）标签列
manbing = manbing.select("erp_code", "d_func", col("drug_5").cast("int").alias('label'))
